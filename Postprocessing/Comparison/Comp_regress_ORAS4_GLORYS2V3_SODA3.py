...
output_path = '/home/yang/NLeSC/Computation_Modeling/BlueAction/OMET/Comparison/regress'
...
for c in np.arange(len(lat_interest_list)):
    ...
    fig1.suptitle('Regression of SLP Anomaly from ERA-Interim on OMET Anomaly of ORAS4 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ...
    # show and save plot
    plt.show()
    fig1.savefig(output_path + os.sep + 'SLP' + os.sep + 'OMET_ORAS4_fields_ERAI' + os.sep + "Regression_OMET_ORAS4_%dN_SLP_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig1)
    # @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@      GLORYS2V3      @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ #
    for i in np.arange(len(latitude_ERAI_fields)):
        for j in np.arange(len(longitude_ERAI_fields)):
    ...
    cube_ERAI.coord('longitude').coord_system = coord_sys
    # suptitle is the title for the figure
    fig2.suptitle('Regression of SLP Anomaly from ERA-Interim on OMET Anomaly of GLORYS2V3 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ax = plt.axes(projection=ccrs.PlateCarree())
    ax.set_global()
    #ax.set_aspect('auto')
    ax.set_aspect('1.0')
    ...
    # show and save plot
    plt.show()
    fig2.savefig(output_path + os.sep + 'SLP' + os.sep + 'OMET_GLORYS2V3_fields_ERAI' + os.sep + "Regression_OMET_GLORYS2V3_%dN_SLP_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig2)
    ...
    cube_ERAI.coord('longitude').coord_system = coord_sys
    # suptitle is the title for the figure
    fig3.suptitle('Regression of SLP Anomaly from ERA-Interim on OMET Anomaly of SODA3 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ax = plt.axes(projection=ccrs.PlateCarree())
    ax.set_global()
    #ax.set_aspect('auto')
    ax.set_aspect('1.0')
    ...
    # show and save plot
    plt.show()
    fig3.savefig(output_path + os.sep + 'SLP' + os.sep + 'OMET_SODA3_fields_ERAI' + os.sep + "Regression_OMET_SODA3_%dN_SLP_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig3)
...
for c in np.arange(len(lat_interest_list)):
    ...
    # show and save plot
    plt.show()
    #fig4.savefig(output_path + os.sep + 'SST' + os.sep + 'OMET_ORAS4_fields_ERAI' + os.sep + "Regression_OMET_ORAS4_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    fig4.savefig(output_path + os.sep + 'SST' + os.sep + 'Detrend' + os.sep + 'OMET_ORAS4_fields_ERAI' + os.sep + "Regression_OMET_ORAS4_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig4)
    ...
    # show and save plot
    plt.show()
    #fig5.savefig(output_path + os.sep + 'SST' + os.sep + 'OMET_GLORYS2V3_fields_ERAI' + os.sep + "Regression_OMET_GLORYS2V3_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    fig5.savefig(output_path + os.sep + 'SST' + os.sep + 'Detrend' + os.sep + 'OMET_GLORYS2V3_fields_ERAI' + os.sep + "Regression_OMET_GLORYS2V3_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig5)
    ...
    # show and save plot
    plt.show()
    #fig6.savefig(output_path + os.sep + 'SST' + os.sep + 'OMET_SODA3_fields_ERAI' + os.sep + "Regression_OMET_SODA3_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    fig6.savefig(output_path + os.sep + 'SST' + os.sep + 'Detrend' + os.sep + 'OMET_SODA3_fields_ERAI' + os.sep + "Regression_OMET_SODA3_%dN_SST_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig6)
...
for c in np.arange(len(lat_interest_list)):
    ...
    cube_ERAI.coord('longitude').coord_system = coord_sys
    # suptitle is the title for the figure
    fig7.suptitle('Regression of TS Anomaly from ERA-Interim on OMET Anomaly of ORAS4 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ax = plt.axes(projection=ccrs.PlateCarree())
    ax.set_global()
    #ax.set_aspect('auto')
    ax.set_aspect('1.0')
    ...
    # show and save plot
    plt.show()
    fig7.savefig(output_path + os.sep + 'TS' + os.sep + 'OMET_ORAS4_fields_ERAI' + os.sep + "Regression_OMET_ORAS4_%dN_TS_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig7)
    ...
    cube_ERAI.coord('longitude').coord_system = coord_sys
    # suptitle is the title for the figure
    fig8.suptitle('Regression of TS Anomaly from ERA-Interim on OMET Anomaly of GLORYS2V3 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ax = plt.axes(projection=ccrs.PlateCarree())
    ax.set_global()
    #ax.set_aspect('auto')
    ax.set_aspect('1.0')
    ...
    # show and save plot
    plt.show()
    fig8.savefig(output_path + os.sep + 'TS' + os.sep + 'OMET_GLORYS2V3_fields_ERAI' + os.sep + "Regression_OMET_GLORYS2V3_%dN_TS_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig8)
    ...
    cube_ERAI.coord('longitude').coord_system = coord_sys
    # suptitle is the title for the figure
    fig9.suptitle('Regression of TS Anomaly from ERA-Interim on OMET Anomaly of SODA3 across %d N' % (lat_interest_list[c]) ,fontsize = 7,y=0.93)
    ax = plt.axes(projection=ccrs.PlateCarree())
    ax.set_global()
    #ax.set_aspect('auto')
    ax.set_aspect('1.0')
    ...
    # show and save plot
    plt.show()
    fig9.savefig(output_path + os.sep + 'TS' + os.sep + 'OMET_SODA3_fields_ERAI' + os.sep + "Regression_OMET_SODA3_%dN_TS_ERAI_white_correlation_coef.jpeg" % (lat_interest_list[c]),dpi=300)
    plt.close(fig9)
