...
for i in np.arange(len(lat_interest_list)):
    ...
    plt.legend()
    plt.show()
    fig1.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'SFflux' + os.sep + 'Comp_SFflux_%dN.jpg' % (lat_interest_list[i]), dpi = 400)
...
for i in np.arange(len(lat_interest_list)):
    ...
    plt.legend()
    plt.show()
    fig2.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'comp' + os.sep + 'Comp_SFflux_OMET_OHC_%dN.jpg' % (lat_interest_list[i]), dpi = 400)
...
for i in np.arange(len(lat_interest_list)):
    ...
    plt.legend()
    plt.show()
    fig3.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'comp' + os.sep + 'Comp_SFflux_OMET_OHC_%dN_lowpass.jpg' % (lat_interest_list[i]), dpi = 400)
...
plt.legend()
plt.show()
fig4.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC.jpg', dpi = 400)
...
# plt.legend()
# plt.show()
# fig5.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_ORAS4.jpg', dpi = 400)
#
# fig6 = plt.figure()
...
# plt.legend()
# plt.show()
# fig6.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_GLORYS2V3.jpg', dpi = 400)
#
# fig7 = plt.figure()
...
# plt.legend()
# plt.show()
# fig7.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_SODA3.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig8.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_ORAS4_40N_90N.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig9.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_GLORYS2V3_40N_90N.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig10.savefig(output_path + os.sep + 'point' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_SODA3_40N_90N.jpg', dpi = 400)
...
for i in np.arange(len(lat_interest_list)-1):
    ...
    plt.legend()
    plt.show()
    fig11.savefig(os.path.join(output_path,'point','globe','block','original_series','Comp_SFflux_OMET_OHC_block_{}N_{}N'.format(lat_interest_list[i],lat_interest_list[i+1])), dpi = 400)
    # whitening
    # seasonal cycling
    ...
    plt.legend()
    plt.show()
    fig12.savefig(os.path.join(output_path,'point','globe','block','anomaly_series','Comp_SFflux_OMET_OHC_white_block_{}N_{}N'.format(lat_interest_list[i],lat_interest_list[i+1])), dpi = 400)
    ...
    plt.legend()
    plt.show()
    fig13.savefig(os.path.join(output_path,'point','globe','block','anomaly_lowpass','Comp_SFflux_OMET_OHC_white_block_window_{}m_{}N_{}N'.format(window,lat_interest_list[i],lat_interest_list[i+1])), dpi = 400)
...
plt.legend()
plt.show()
fig4.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC.jpg', dpi = 400)
...
# plt.legend()
# plt.show()
# fig5.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_ORAS4.jpg', dpi = 400)
#
# fig6 = plt.figure()
...
# plt.legend()
# plt.show()
# fig6.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_GLORYS2V3.jpg', dpi = 400)
#
# fig7 = plt.figure()
...
# plt.legend()
# plt.show()
# fig7.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_SODA3.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig8.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_ORAS4_20N_90N.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig9.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_GLORYS2V3_20N_90N.jpg', dpi = 400)
...
plt.legend()
plt.show()
fig10.savefig(output_path + os.sep + 'band' + os.sep + 'globe' + os.sep + 'Trend_SFflux_OMET_OHC_SODA3_20N_90N.jpg', dpi = 400)
