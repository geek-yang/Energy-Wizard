...
print '*******************************************************************'
# zonal integral
dataset = Dataset(datapath + os.sep + 'AMET_EC-earth_model_daily_1979_2016_E_zonal_int.nc')
# spacial distribution
dataset_point = Dataset(datapath + os.sep + 'AMET_EC-earth_model_daily_1979_2016_E_point.nc')
