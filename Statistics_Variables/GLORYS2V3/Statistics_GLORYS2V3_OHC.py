...
logging.basicConfig(filename = '/project/Reanalysis/GLORYS2V3/monthly/history_OHC.log',
...
def create_netcdf_point (psi_pool_glo_zonal, psi_pool_atl_zonal, psi_pool_glo_vert, psi_pool_atl_vert,\
    ...
    data_wrap = Dataset(output_path + os.sep + 'GLORYS2V3_model_monthly_orca025_OHC_point.nc' ,'w',format = 'NETCDF3_64BIT')
