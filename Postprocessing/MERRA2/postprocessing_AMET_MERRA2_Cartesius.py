...
Function        : Postprocessing meridional energy transport from Cartesius (MERRA2)
Author          : Yang Liu
Date            : 2017.11.28
...
Description     : The code aims to postprocess the output from the HPC cloud
                  ...
                  transport based on atmospheric reanalysis dataset MERRA2 from
                  NASA. The complete procedure includes data extraction and
                  making plots.
...
################################   Input zone  ######################################
# specify data path
datapath = 'F:\DataBase\HPC_out\MERRA2\postprocessing'
# specify output path for the netCDF4 file
output_path = 'F:\DataBase\HPC_out\MERRA2\postprocessing'
Lat_num = 60 # index 80
####################################################################################
print '*******************************************************************'
...
print '*******************************************************************'
# zonal integral
dataset = Dataset(datapath + os.sep + 'AMET_MERRA2_model_daily_1980_2016_E_zonal_int.nc')
# spacial distribution
dataset_point = Dataset(datapath + os.sep + 'AMET_MERRA2_model_daily_1980_2016_E_point.nc')
...
index_year = np.arange(1980,1980+len(year)+1,1)
...
fig1 = plt.figure()
plt.plot(index,T_series_E[80,:]/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Energy Transport time series at %d N (1980-2016)' % (Lat_num))
#plt.legend()
...
plt.show()
fig1.savefig(output_path + os.sep + 'Meridional_Energy_%dN_total_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)

fig2 = plt.figure()
plt.plot(index,T_series_E_internal[80,:]/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Internal Energy Transport time series at %d N (1980-2016)' % (Lat_num))
#plt.legend()
...
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig2.savefig(output_path + os.sep + 'Meridional_Energy_%dN_internal_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)

fig3 = plt.figure()
plt.plot(index,T_series_E_latent[80,:]/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Latent Energy Transport time series at %d N (1980-2016)' % (Lat_num))
#plt.legend()
...
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig3.savefig(output_path + os.sep + 'Meridional_Energy_%dN_latent_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)

fig4 = plt.figure()
plt.plot(index,T_series_E_geopotential[80,:]/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Geopotential Energy Transport time series at %d N (1980-2016)' % (Lat_num))
#plt.legend()
...
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig4.savefig(output_path + os.sep + 'Meridional_Energy_%dN_geopotential_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)

fig5 = plt.figure()
plt.plot(index,T_series_E_kinetic[80,:]/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Kinetic Energy Transport time series at %d N (1980-2016)' % (Lat_num))
#plt.legend()
...
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig5.savefig(output_path + os.sep + 'Meridional_Energy_%dN_kinetic_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)

# everything in one plot
fig6 = plt.figure()
plt.plot(index,T_series_E_internal[80,:]/1000,'r--',label='cpT')
plt.plot(index,T_series_E_latent[80,:]/1000,'m-.',label='Lvq')
plt.plot(index,T_series_E_geopotential[80,:]/1000,'g:',label='gz')
plt.plot(index,T_series_E_kinetic[80,:]/1000,'c:',label='u2')
plt.plot(index,T_series_E[80,:]/1000,'b-',label='total')
plt.title('Atmospheric Meridional Energy Transport time series at %d N (1980-2016)' % (Lat_num))
plt.legend()
...
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig6.savefig(output_path + os.sep + 'Meridional_Energy_%dN_eachComponent_time_series_1980_2016.jpg' % (Lat_num), dpi = 500)
...
plt.title('Atmospheric Meridional Energy Transport time series(1980-2016)' )
...
plt.show()
fig7.savefig(output_path + os.sep + 'Meridional_Energy_total_time_series_1980_2016_shades.jpg', dpi = 500)
...
plt.plot(latitude,np.mean(series_E,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Energy Transport (1980-2016)' )
#plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig8.savefig(output_path + os.sep + 'Meridional_Energy_total_mean_1980_2016.jpg', dpi = 500)

fig9 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_internal,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Internal Energy Transport (1980-2016)' )
#plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig9.savefig(output_path + os.sep + 'Meridional_Energy_internal_mean_1980_2016.jpg', dpi = 500)

fig10 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_latent,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Latent Energy Transport (1980-2016)' )
#plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig10.savefig(output_path + os.sep + 'Meridional_Energy_latent_mean_1980_2016.jpg', dpi = 500)

fig11 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_geopotential,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Geopotential Energy Transport (1980-2016)' )
#plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig11.savefig(output_path + os.sep + 'Meridional_Energy_geopotential_mean_1980_2016.jpg', dpi = 500)

fig12 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_kinetic,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional kinetic Energy Transport (1980-2016)' )
#plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig12.savefig(output_path + os.sep + 'Meridional_Energy_kinetic_mean_1980_2016.jpg', dpi = 500)
...
#plt.plot(latitude,np.mean(T_series_E_kinetic,0)/1000,'b-',label='MERRA2')
plt.title('Atmospheric Meridional Energy Transport (1980-2016)' )
plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig13.savefig(output_path + os.sep + 'Meridional_Energy_eachComponent_mean_1980_2016.jpg', dpi = 500)
...
fig14 = plt.figure()
plt.axes(polar = True)
plt.plot(angle_series,T_series_E[80,:]/1000,'b--',label='MERRA2')
plt.title('Atmospheric Meridional Energy Transport at %d N (1980-2016)' % (Lat_num), y=1.07)
#plt.legend()
...
#plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig14.savefig(output_path + os.sep + 'Meridional_Energy_%dN_total_windrose_1980_2016.jpg' % (Lat_num), dpi = 500)

# wind rose of time series after removing seasonal cycles

fig15 = plt.figure()
plt.axes(polar = True)
plt.plot(angle_series,T_series_E_white[80,:]/1000,'b--',label='MERRA2')
plt.title('Atmospheric Meridional Energy Transport anomaly at %d N (1980-2016)' % (Lat_num), y=1.07)
#plt.legend()
#fig10.set_size_inches(14, 4)
#plt.xlabel("Time")
plt.xticks(angle[:-1], month_str)
...
#plt.ylabel("Meridional Energy Transport (PW)")
plt.show()
fig15.savefig(output_path + os.sep + 'Meridional_Energy_%dN_total_windrose_white_1980_2016.jpg' % (Lat_num), dpi = 500)
...
plt.title('Mean Meridional Energy Transport (1980-2016)',fontsize = 9, y=1.05)
plt.show()
fig16.savefig(output_path + os.sep + "Map_AMET_MERRA2_mean.jpeg",dpi=500)
...
cbar.ax.tick_params(labelsize=8)
cbar.set_label('Peta Watt',fontsize = 8)
plt.title('Mean Meridional Energy Transport Anomaly (1980-2016)',fontsize = 9, y=1.05)
plt.show()
fig17.savefig(output_path + os.sep + "Map_AMET_MERRA2_anomaly_mean.jpeg",dpi=500)
...
plt.title('Trend of AMET anomaly (1980-2016)',fontsize = 9, y=1.05)
plt.show()
fig18.savefig(output_path + os.sep + "Map_AMET_MERRA2_anomaly_trend.jpeg",dpi=500)
