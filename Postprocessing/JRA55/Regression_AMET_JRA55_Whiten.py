...
datapath_y = "/mnt/Associate/DataBase/ERA_Interim/Monthly"
...
# These climitology data comes from JRA55 surface level
...
plt.show()
fig14.savefig(output_path + os.sep + "Regression_AMET_SLP_JRA55_white_correlation_coef.jpeg",dpi=500)
...
plt.title('Regression of SLP Anomaly on AMET Anomaly across 60 N',fontsize = 9, y=1.05)
plt.show()
fig15.savefig(output_path + os.sep + "Regression_AMET_SLP_JRA55_white_regression_coef.jpeg",dpi=500)
...
plt.show()
fig16.savefig(output_path + os.sep + "Regression_AMET_SST_JRA55_white_correlation_coef.jpeg",dpi=500)
...
plt.title('Regression of SST Anomaly on AMET Anomaly across 60 N',fontsize = 9, y=1.05)
plt.show()
fig17.savefig(output_path + os.sep + "Regression_AMET_SST_JRA55_white_regression_coef.jpeg",dpi=500)
...
plt.show()
fig18.savefig(output_path + os.sep + "Regression_AMET_Ice_JRA55_white_correlation_coef.jpeg",dpi=500)
...
plt.title('Regression of Sea Ice Concentration Anomaly on AMET Anomaly across 60 N',fontsize = 9, y=1.05)
plt.show()
fig19.savefig(output_path + os.sep + "Regression_AMET_Ice_JRA55_white_regression_coef.jpeg",dpi=500)
