...
################################   Input zone  ######################################
# specify data path
datapath = '/home/yang/workbench/Core_Database_AMET_OMET_reanalysis/JRA55/postprocessing'
...
print '*******************************************************************'
# zonal integral
dataset = Dataset(datapath + os.sep + 'AMET_JRA55_model_daily_1979_2015_E_zonal_int.nc')
# spacial distribution
dataset_point = Dataset(datapath + os.sep + 'AMET_JRA55_model_daily_1979_2015_E_point.nc')
...
fig1 = plt.figure()
plt.plot(index,T_series_E[53,:]/1000,'b-',label='JRA55')
...
fig2 = plt.figure()
plt.plot(index,T_series_E_internal[53,:]/1000,'b-',label='JRA55')
...
fig3 = plt.figure()
plt.plot(index,T_series_E_latent[53,:]/1000,'b-',label='JRA55')
...
fig4 = plt.figure()
plt.plot(index,T_series_E_geopotential[53,:]/1000,'b-',label='JRA55')
...
fig5 = plt.figure()
plt.plot(index,T_series_E_kinetic[53,:]/1000,'b-',label='JRA55')
...
fig6 = plt.figure()
plt.plot(index,T_series_E_internal[53,:]/1000,'r--',label='cpT')
plt.plot(index,T_series_E_latent[53,:]/1000,'m-.',label='Lvq')
plt.plot(index,T_series_E_geopotential[53,:]/1000,'g:',label='gz')
plt.plot(index,T_series_E_kinetic[53,:]/1000,'c:',label='u2')
plt.plot(index,T_series_E[53,:]/1000,'b-',label='total')
plt.title('Atmospheric Meridional Energy Transport time series at %d N (1979-2015)' % (Lat_num))
plt.legend()
...
plt.plot(latitude,np.mean(series_E,0)/1000,'b-',label='JRA55')
...
fig9 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_internal,0)/1000,'b-',label='JRA55')
...
fig10 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_latent,0)/1000,'b-',label='JRA55')
...
fig11 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_geopotential,0)/1000,'b-',label='JRA55')
...
fig12 = plt.figure()
plt.axhline(y=0, color='r',ls='--')
plt.plot(latitude,np.mean(series_E_kinetic,0)/1000,'b-',label='JRA55')
...
#plt.plot(latitude,np.mean(T_series_E_kinetic,0)/1000,'b-',label='JRA55')
plt.title('Atmospheric Meridional Energy Transport (1979-2015)' )
plt.legend()
plt.xlabel("Latitudes")
#plt.xticks()
...
fig14 = plt.figure()
plt.axes(polar = True)
plt.plot(angle_series,T_series_E[53,:]/1000,'b--',label='JRA55')
...
fig15 = plt.figure()
plt.axes(polar = True)
plt.plot(angle_series,T_series_E_white[53,:]/1000,'b--',label='JRA55')
...
m = Basemap(projection='npstere',round=True,lon_0=0,resolution='l')
# draw coastlines
m.drawcoastlines()
...
plt.show()
fig16.savefig(output_path + os.sep + "Map_AMET_JRA55_mean.jpeg",dpi=500)
...
plt.show()
fig17.savefig(output_path + os.sep + "Map_AMET_JRA55_anomaly_mean.jpeg",dpi=500)
...
plt.show()
fig18.savefig(output_path + os.sep + "Map_AMET_JRA55_anomaly_trend.jpeg",dpi=500)
